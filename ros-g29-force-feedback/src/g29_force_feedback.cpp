...
G29ForceFeedback::G29ForceFeedback() 
    ...
    declare_parameter("loop_rate", 0.01);
    declare_parameter("max_torque", 1.0);
    declare_parameter("min_torque", 0.2);
    declare_parameter("brake_position", 0.2);
    declare_parameter("brake_torque", 0.1);
